"""
Django settings for Travel Agency API.

Generated for RESTful API with JWT, PostgreSQL (in Docker), and Swagger.
"""
...
# Templates are not used in pure API, but kept for admin
TEMPLATES = [
    {
...
# Database
# Uses PostgreSQL in Docker, SQLite locally
if os.environ.get('DOCKER_CONTAINER'):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.getenv('POSTGRES_DB', 'travel_agency'),
...
# Static files (not needed for pure API, but required for admin)
STATIC_URL = '/static/'
...
SPECTACULAR_SETTINGS = {
    ...
    'SWAGGER_UI_SETTINGS': {
        'persistAuthorization': True,  # Сохраняет токен в Swagger
    },
